...
<%
	...
	String e = s.getAttribute("cust_login").toString();
	if(e.equals(""))
	{
	...
	String str = "";
	ResultSet r = CompanyDao.getAllDetails(); //getting company cymbol
	
	if(r.next())
	{
		str = r.getString("csymbol");
	}
	
	
	ResultSet rs = null;
	String email = "";
	rs = CompanyDao.getAllDetails(str); //all details using csymbol
	while(rs.next())
	{
