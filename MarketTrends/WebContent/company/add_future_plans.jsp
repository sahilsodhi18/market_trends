...
<meta http-equiv="content-type" content="text/html" />
	...
	<title>MarketTrends | Future Plans</title>
    <!-- Bootstrap files -->    
...
<div class="col-sm-12">
    ...
    <div class="col-sm-4 customerlogin center">
           ...
           <hr />
        	...
        	<br/>
          <form class="form-horizontal" role="form" method="post" action="future_plans_check">
            
            <div class="form-group">
              <div class="col-sm-12">
                <textarea class="form-control" name="fplans" placeholder="Enter Future Plans" required ></textarea>
              </div>
            </div>
