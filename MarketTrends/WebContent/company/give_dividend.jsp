...
<meta http-equiv="content-type" content="text/html" />
	...
	<title>MarketTrends | Dividend</title>
    <!-- Bootstrap files -->    
...
<div class="col-sm-12">
    ...
    <div class="col-sm-4 customerlogin center">
           ...
           <hr />
        	...
        	<br/>
          <form class="form-horizontal" role="form" method="post" action="give_dividend_check">
            
            <div class="form-group">
              <div class="col-sm-12">
                <input type="text" class="form-control" name="amt" pattern="[0-9.]*" placeholder="Enter Amount" required >
              </div>
            </div>
